...
| List an ontology's apps | `GET /apps/{ontology_id}/list` |
| Get a definition | `GET /apps/{ontology_id}/{app_id}` |
| Create / update (validates) | `POST /apps/{ontology_id}/save` |
| Delete (incl. history) | `DELETE /apps/{ontology_id}/{app_id}` |
| List versions | `GET /apps/{ontology_id}/{app_id}/versions` |
| Restore a version | `POST /apps/{ontology_id}/{app_id}/versions/{version_id}/restore` |
| Bookmark a version | `PATCH /apps/{ontology_id}/{app_id}/versions/{version_id}/bookmark` |
