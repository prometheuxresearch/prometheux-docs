...
description: "The three-pane environment where you build and maintain Dynamic Apps."
---
...
![The App Editor: outline on the left, live preview in the center, the selected widget's inspector on the right](/images/dynamic-apps/editor-layout.png)
...
![The JSON view: the raw definition replaces the canvas, the side panels stay in sync](/images/dynamic-apps/editor-json-view.png)
...
![A failed save: every dangling reference is listed and nothing is persisted](/images/dynamic-apps/editor-validation.png)
...
![The Versions panel: one checkpoint per save, newest first](/images/dynamic-apps/editor-versions.png)
...
![A catalog card's hover actions: export, edit, delete](/images/dynamic-apps/catalog-card-actions.png)
