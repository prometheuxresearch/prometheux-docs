...
The editor is a live preview of your app flanked by two rails:

```
┌──────────┬──────────────────────────────┬────────────┐
│ Left rail│                              │ Right rail │
│          │                              │            │
│ Structure│      Live preview            │ Inspector  │
│ Data     │      (the canvas)            │    or      │
│ Concepts │                              │ Versions   │
└──────────┴──────────────────────────────┴────────────┘
```

**The preview is the canvas.** There is no separate design surface: what you see in the center is the running app. Click any widget to select it and edit it in the inspector.
