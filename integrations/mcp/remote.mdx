...
<Info>
**Looking for a Simpler Local Setup?**
...
| **ChatGPT** (OpenAI) | [Connect ChatGPT](/integrations/mcp/chatgpt) |
| **Genie Code** (Databricks) | [Connect Genie Code](/integrations/mcp/databricks-genie) |
| **Snowflake Cortex** (Cortex Code & Intelligence) | [Connect Snowflake Cortex](/integrations/mcp/snowflake-cortex) |
| **Cursor** | [Connect Cursor](/integrations/mcp/cursor) |
| **Claude Code** (Terminal CLI) | [Connect Claude Code](/integrations/mcp/claude-code) |

<Tip>
**Coding Agents**

For coding agents like **Cursor** and **Claude Code**, we recommend using the [Local MCP Server](/integrations/mcp/local) instead. It uses stdio transport with direct credentials, which avoids the OAuth browser flow and is more reliable in IDE and terminal environments.
</Tip>
...
- Be more explicit in your query: "Use the prometheux tools to list concepts in ontology X"
