...
unless noted otherwise. Paginated endpoints follow [pagination](/integrations/rest-api#pagination).
...
Return all registered data sources for the authenticated user. No parameters required.
...
|---|---|---|
| Remove data sources | `POST /data/cleanup` | Body: `source_ids` (array; omit to delete all sources). |
